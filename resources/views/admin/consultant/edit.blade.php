        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="page-header" id="top">
                    <h2 class="pageheader-title">Edit Consultant </h2>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Edit Consultant</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-10">
              <div class="card mb-5 shadow-sm">
                <h5 class="card-header">Edit Consultant</h5>
                <div class="card-body">
                  <form method="post" action="{{ route('consultant.update',$user->id) }}" id="profile_update" enctype="multipart/form-data">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="m-r-10 mt-2"><img src="{{ $user->image }}" alt="user" width="80" class="rounded-circle"  /></div>
                    <br>
