                  ...
                  <form method="post" action="{{ route('members.store') }}" id="add_members" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-2">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-id-card-o"></i></span></div>
                          <input id="pancard_no" type="text" name="pancard_no" class="form-control" placeholder="Pan Card Number" value="{{ old('pancard_no') }}">
                    </div>
                    @error('pancard_no')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                    <div class="input-group mb-2">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-bank"></i></span></div>
                          <input id="bank_act_no" type="text" name="bank_act_no" class="form-control" placeholder="Bank Acount Number" value="{{ old('bank_act_no') }}">
                    </div>
                    @error('bank_act_no')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                    <div class="input-group mb-2">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-code"></i></span></div>
                          <input id="member_code" type="number" name="member_code" class="form-control" placeholder="Member Code" maxlength="20" minlength="0"value="{{ old('member_code') }}">
                    </div>
                    @error('member_code')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                    <div class="input-group mb-2">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-inr"></i></span></div>
                          <input id="principal_amount" type="number" name="principal_amount" class="form-control" placeholder="Principal Amount"maxlength="10" minlength="0" value="{{ old('principal_amount') }}">
                    </div>
